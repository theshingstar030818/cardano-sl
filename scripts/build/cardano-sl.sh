...
# We can't have rubbish, wallet or explorer here, because it depends on 'cardano-sl'.
...
if [[ $spec_prj == "" ]]; then
  ...
  to_build="$to_build cardano-sl cardano-sl-rubbish cardano-sl-tools cardano-sl-wallet cardano-sl-explorer"
  ...
  to_build="cardano-sl cardano-sl-rubbish cardano-sl-tools cardano-sl-explorer cardano-sl-wallet "
else
