...
data GenesisData = GenesisData
    { gcBootStakeholders :: !GenesisWStakeholders
    , gcHeavyDelegation  :: !GenesisDelegation
    , gcStartTime        :: !Timestamp
    , gcVssCerts         :: !VssCertificatesMap
    , gcNonAvvmBalances  :: !(HashMap Address Coin)
    , gcBlockVersionData :: !BlockVersionData
